...
browser.goto "#{site}Home/Archive"

articles_without_mp3 = browser.articles.collect do |article|
  title = article.a.text
  number = title.split(" ")[1].to_i
  url = article.a.href
...
articles_with_mp3 = articles_without_mp3.collect do |article|
  browser.goto article[:url]
  article[:mp3] = browser.a(text: "Download Podcast").href
  article
end

require "pp"
pp articles_with_mp3
